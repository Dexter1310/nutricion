...
class NoteController extends AbstractController
{
    ...
    public function notesAction(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->serviceNote->newNote($note,$this->getUser());
    ...
    #[Route('/note_delete/{id}', name: 'note_delete')]
    public function deleteNoteAction(Request $request,int $id): Response
    {
        $message=$this->serviceNote->deleteNote($id);

        return $this->redirect('/notes_list');
    }
